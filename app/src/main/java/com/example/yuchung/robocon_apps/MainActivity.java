...
public class MainActivity extends AppCompatActivity {
    ...
    public class PS4 {
        ...
        private byte temp3 = 0;
        private byte options = 0;   //1 bit
        private byte share = 0;     //1 bit
        private byte commands = 0;  //6 bit

        public void display() {
            temp1 = (byte) (dpad_code << 4);
            temp1 = (byte) (temp1 | (byte)(square << 3));
            temp1 = (byte) (temp1 | (byte)(cross << 2));
            temp1 = (byte) (temp1 | (byte)(circle << 1));
            temp1 = (byte) (temp1 | triangle);

            temp2 = (byte) (temp2 | (byte)(l1 << 7));
            temp2 = (byte) (temp2 | (byte)(r1 << 6));
            temp2 = (byte) (temp2 | (byte)(l2 << 5));
            temp2 = (byte) (temp2 | (byte)(r2 << 4));
            temp2 = (byte) (temp2 | (byte)(l3 << 3));
            temp2 = (byte) (temp2 | (byte)(r3 << 2));
            temp2 = (byte) (temp2 | (byte)(ps << 1));
            temp2 = (byte) (temp2 | tpad_click);

            temp3 = (byte) (temp3 | (byte)(options << 7));
            temp3 = (byte) (temp3 | (byte)(share << 6));
            temp3 = (byte) (temp3 | commands);
            ...
            value_R_list[2] = Byte.toString(temp1);
            value_R_list[3] = Byte.toString(temp2);
            value_R_list[4] = Byte.toString(temp3);
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if ( event.getAxisValue(MotionEvent.AXIS_HAT_Y) == -1 ){
                        ...
                        else if ( event.getAxisValue(MotionEvent.AXIS_HAT_X) == -1 ) ps4.dpad_code = 7;
                        ...
                        else if ( event.getAxisValue(MotionEvent.AXIS_HAT_X) == -1 ) ps4.dpad_code = 6;
                        ...
                        else if ( event.getAxisValue(MotionEvent.AXIS_HAT_X) == -1 ) ps4.dpad_code = 5;
                    }
